package com.rafelis1997.minhasreceitasapp.presentation.detail.adapter
...
import com.rafelis1997.minhasreceitasapp.databinding.ItemFullRecipeBinding
...
class DiffCallback : DiffUtil.ItemCallback<ItemListModel>() {
    override fun areItemsTheSame(oldItem: ItemListModel, newItem: ItemListModel) = oldItem == newItem
